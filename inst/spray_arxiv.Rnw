...
Hankin, R. K.~S. (2008).
\newblock {{P}rogrammers' {N}iche}: {M}ultivariate polynomials in {\tt r}.
\newblock {\em {\tt R} News}, 8(1):41--45.

\bibitem[Hankin, 2019]{hankin2019}
Hankin, R. K.~S. (2019).
\newblock {\em {\tt mvp}: Fast Symbolic Multivariate Polynomials}.
\newblock {\tt R} package version 1.0-5.
...
\newblock {\tt R} package version 0.1-32.

\bibitem[Kahle, 2013]{kahle2013}
Kahle, D. (2013).
\newblock {\tt mpoly}: Multivariate polynomials in {\tt r}.
\newblock {\em The {\tt R} Journal}, 5(1):162--170.
...
\newblock {\tt R} package version 1.3-9. {\tt S} original by Bill Venables,
  packages for {\tt R} by Kurt Hornik and Martin Maechler.
