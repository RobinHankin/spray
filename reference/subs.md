...
#> +a^3*c^2*d^3*e^2 +a^3*b^2*d^3 +a*b*c*d*e

subs(S, c(2,5), 1:2)
#> +a^3*c^3 +a^2*b^2 +4*a^3*b^2*c^3 +4*a^2 +a^2*b^3 +a^2*b^2*c^2 +2*a*b*c
#> +2*a^2*b^3*c +8*a^2*b^2*c^3 +a*c +2*a^2*b^3*c^3 +2*a^2*b*c
